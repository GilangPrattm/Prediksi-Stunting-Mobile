...
class _LoginPageState extends State<LoginPage>
  ...
  // --- TEMA WARNA BIRU (Sesuai Register Page) ---
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.transparent, // Transparan agar menyatu dengan gradient
        elevation: 0,
        centerTitle: true,
        title: const Text(
          'Stunt Check',
      ...
      extendBodyBehindAppBar: true, // Memperluas background ke belakang AppBar
      body: Container(
        // [PERBAIKAN 1]: Memberikan Gradient agar tidak polosan
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            begin: Alignment.topCenter,
            end: Alignment.bottomCenter,
            colors: [Color(0xFFD7E3FF), Color(0xFFFFFFFF)], // Biru muda ke putih
          ),
        ),
        child: SafeArea(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // [PERBAIKAN 1]: Checkbox 'Ingat Saya' dihapus
          Align(
