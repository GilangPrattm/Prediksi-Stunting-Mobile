...
class _TambahAnakPageState extends State<TambahAnakPage> {
  ...
  final TextEditingController _namaOrtuController = TextEditingController(text: 'Terisi otomatis');
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: const ColorScheme.light(
              primary: Color(0xFF0D9488), // Warna header kalendernya Teal
  ...
  void _prosesSimpan() async {
    ...
    if (_nikController.text.isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Selesaikan isian Identitas Anak seperti NIK, Nama, Tanggal Lahir, & Jenis Kelamin ya Bunda!'),
    ...
    Map<String, dynamic> dataKirim = {
      ...
      'nama_ortu': _namaOrtuController.text == 'Terisi otomatis' ? '' : _namaOrtuController.text,
    ...
    if (sukses) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Data anak sukses ditambahkan!'), backgroundColor: Colors.green),
      );
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Gagal menyimpan data, pastikan server merespons.'), backgroundColor: Colors.red),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Tambah Data Anak', style: TextStyle(color: Colors.black87, fontSize: 18, fontWeight: FontWeight.bold)),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Row(
                      children: [
                        ...
                        SizedBox(width: 10),
                        Expanded(child: Text('Pastikan data disalin dengan benar dari Buku KIA ya Bunda agar Kila AI bisa memantau.', style: TextStyle(color: primaryColor, fontSize: 13))),
                      ],
                    ),
                  ),

                  // CARD 1: IDENTITAS ANAK
                  const Text('1. Identitas Anak', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF1E293B))),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildReadOnlyField(_namaOrtuController, Icons.person_outline),
                        ...
                        _buildDateTextField(_tglLahirController, 'Pilih Tanggal Lahir', context),
                      ],
                    ),
                  ),
                  ...
                  const Text('2. Data Kelahiran', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF1E293B))),
                  const SizedBox(height: 10),
                  Container(
                    padding: const EdgeInsets.all(20),
                    decoration: BoxDecoration(
                  ...
                  const Text('3. Pemeriksaan Terakhir di Posyandu', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF1E293B))),
                  const SizedBox(height: 10),
                  Container(
                    padding: const EdgeInsets.all(20),
                    decoration: BoxDecoration(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildDateTextField(_tglPemeriksaanController, 'Pilih Tanggal', context),
  ...
  Widget _buildLabel(String text) {
    return Padding(
      ...
      child: Text(text, style: const TextStyle(fontWeight: FontWeight.w600, color: Color(0xFF64748B), fontSize: 13)),
    );
  }
  ...
  Widget _buildDateTextField(TextEditingController controller, String hint, BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: Colors.grey[50],
        prefixIcon: const Icon(Icons.calendar_month, color: Color(0xFF0D9488)),
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: BorderSide.none),
      ),
    );
  }
